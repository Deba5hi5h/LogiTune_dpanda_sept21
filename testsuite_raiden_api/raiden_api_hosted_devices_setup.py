...
class RaidenAPIHostedDevicesSetup(UIBase):
    ...
    def test_001_VC_11009_install_sync_app_and_connect_to_sync_portal(self):
        ...
        Prerequisite: Connect COS devices in device mode to acroname connected to the
        ...
        devices = ["Raiden Hosted Rally Bar", "Raiden Hosted Rally Bar Mini", "Raiden Hosted Rally Bar Huddle",
                   "Raiden Hosted Sight"]
...
if __name__ == "__main__":
    test_suite = unittest.TestLoader().loadTestsFromTestCase(RaidenAPIHostedDevicesSetup)
