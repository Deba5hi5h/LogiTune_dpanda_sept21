...
class RaidenAPICollabOSCompatibilitySetup(UIBase):
    ...
    def test_001_VC_11009_install_sync_app_and_connect_to_sync_portal(self):
        ...
        Connect device(s) to the computer via acroname running sync app.
        :param none
        :return none
        """
        ...
        disconnect_all()
        connect_device("Rally Bar")
        time.sleep(10)


if __name__ == "__main__":
    test_suite = unittest.TestLoader().loadTestsFromTestCase(RaidenAPICollabOSCompatibilitySetup)
