...
class RaidenAPITapIPFWUpdate(UIBase):
    """
    Test to verify device APIs for Tap IP.
    """
    ...
    def setUpClass(cls):
        try:
            super(RaidenAPITapIPFWUpdate, cls).setUpClass()
            cls.role = 'OrgAdmin'
    ...
    def tearDownClass(cls):
        super(RaidenAPITapIPFWUpdate, cls).tearDownClass()

    def setUp(self):
        super(RaidenAPITapIPFWUpdate, self).setUp()

    def tearDown(self):
        super(RaidenAPITapIPFWUpdate, self).tearDown()

    def test_2601_VC_129530_Provision_Tap_IP_to_Sync_Portal(self):
    ...
    def test_2602_VC_129534_FW_Update_Tap_IP(self):
    ...
    def test_2603_VC_12815_Delete_Room(self):
        self.syncportal_methods.tc_delete_room(self.role, self.room_name)


if __name__ == "__main__":
    test_suite = unittest.TestLoader().loadTestsFromTestCase(RaidenAPITapIPFWUpdate)
