...
class RaidenAPIMeetingRoomTearDown(UIBase):
    ...
    def test_6001_VC_11135_delete_room_from_sync_portal_and_uninstall_sync_app(self):
        """
        Method to delete room from sync portal and uninstall sync app from computer
...
if __name__ == "__main__":
    test_suite = unittest.TestLoader().loadTestsFromTestCase(RaidenAPIMeetingRoomTearDown)
