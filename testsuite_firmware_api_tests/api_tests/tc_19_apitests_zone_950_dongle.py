...
from testsuite_firmware_api_tests.api_tests.api_parameters import local_api_pc_configuration, zone_950_api
...
from testsuite_firmware_api_tests.api_tests.headsets_earbuds_firmware_api.device_config_zone_950 import \
    FEATURES_ZONE_950, MAX_LEN_NAME, EQ_MODES, CONNECTED_DEVICES, CONNECTED, NOT_CONNECTED
...
class ZoneWireles2ApiDongleTests(UIBase):
    ...
    def setUpClass(cls):
        ...
        cls.centurion = CenturionCommands(device_name=zone_950_api.name,
                                          conn_type=ConnectionType.dongle,
                                          com_port=local_api_pc_configuration.com_port)
        cls.features = Features(cls.centurion)
        global_variables.firmware_api_device_name = "ZONE_950"
    ...
    def test_1901_VC_74320_get_protocol_version(self) -> None:
        try:
    ...
    def test_1902_VC_74321_get_features(self):
        try:
            response = self.features.root_feature.get_features(FEATURES_ZONE_950)
            self.features.root_feature.verify_get_features_responses(
                response, FEATURES_ZONE_950
            )
        except Exception as ex:
            Report.logException(str(ex))

    def test_1903_VC_74322_get_not_supported_feature(self) -> None:
        try:
    ...
    def test_1904_VC_74323_get_not_existing_feature(self) -> None:
        try:
    ...
    def test_1905_VC_74324_get_feature_count(self) -> None:
        try:
            response = self.features.feature_set_feature.get_feature_count()
            self.features.feature_set_feature.verify_feature_count(
                response, len(FEATURES_ZONE_950.keys())
            )
        except Exception as ex:
            Report.logException(str(ex))

    def test_1906_VC_74325_get_feature_id(self) -> None:
        try:
    ...
    def test_1907_VC_74335_get_serial_number(self) -> None:
        try:
            response = self.features.device_info_feature.get_serial_number()
            self.features.device_info_feature.verify_serial_number(
                response, zone_950_api.serial_number
            )
        except Exception as ex:
            Report.logException(str(ex))

    def test_1908_VC_74336_get_firmware_version(self) -> None:
        try:
            response = self.features.device_info_feature.get_firmware_version()
            self.features.device_info_feature.verify_firmware_version(
                response, zone_950_api.firmware_version
            )
        except Exception as ex:
            Report.logException(str(ex))

    def test_1909_VC_74337_get_hardware_info(self) -> None:
        try:
            model_id = zone_950_api.model_id
            hw_revision = "04"
            if zone_950_api.earbud_color == "ROSE":
                color_code = '0100'
            elif zone_950_api.earbud_color == "OFF-WHITE":
                color_code = '0200'
            else:
                color_code = '0000'
    ...
    def test_1910_VC_74338_set_and_get_device_name(self) -> None:
        try:
            NAME = zone_950_api.name + " {}".format(random.randint(0, 10000))
    ...
    def test_1911_VC_74339_get_default_device_name(self) -> None:
        try:
            response = self.features.device_name_feature.get_default_device_name()
            self.features.device_name_feature.verify_default_name(
                response, zone_950_api.name
            )
        except Exception as ex:
            Report.logException(str(ex))

    def test_1912_VC_74340_get_max_length_name(self) -> None:
        try:
    ...
    def test_1913_VC_74341_set_longer_than_max_length_name(self) -> None:
        try:
    ...
    def test_1914_VC_74386_get_battery_status(self) -> None:
        try:
    ...
    def test_1915_VC_74387_get_voltage_info(self) -> None:
        try:
    ...
    def test_1916_VC_74345_set_get_sleep_timer(self) -> None:
        try:
    ...
    def test_1917_VC_74381_get_supported_language(self) -> None:
        try:
    ...
    def test_1918_VC_74382_set_not_supported_language(self) -> None:
        try:
    ...
    def test_1919_VC_74383_get_language_capability(self) -> None:
        try:
            response = self.features.earcon_feature.get_language_capability()
            self.features.earcon_feature.verify_get_language_capability(response, device_name=zone_950_api.name)
        except Exception as ex:
            Report.logException(str(ex))

    def test_1920_VC_74342_set_get_eq(self) -> None:
        try:
    ...
    def test_1921_VC_74343_get_eq_modes(self) -> None:
        try:
    ...
    def test_1922_VC_74344_get_band_info(self) -> None:
        try:
    ...
    def test_1923_VC_74347_anc_off(self) -> None:
        try:
            tested_status = 0
            other_states = [1, 2, 3]
    ...
    def test_1924_VC_74348_anc_on(self) -> None:
        try:
            tested_status = 1
            other_states = [0, 2, 3]
            if self.features.headset_audio_feature.get_current_anc_state(
    ...
    def test_1925_VC_74349_transparency_on(self) -> None:
        try:
            tested_status = 2
            other_states = [0, 1, 3]
            if self.features.headset_audio_feature.get_current_anc_state(
    ...
    def test_1926_VC_74350_anc_low(self) -> None:
        try:
            tested_status = 3
            other_states = [0, 1, 2]
            if self.features.headset_audio_feature.get_current_anc_state(
    ...
    def test_1927_VC_74351_anc_with_not_supported_value(self) -> None:
        try:
    ...
    def test_1928_VC_74346_set_get_mic_mute_state(self) -> None:
        try:
            statuses = [0, 1]
    ...
    def test_1929_VC_74352_set_not_supported_mic_mute_value(self) -> None:
        try:
    ...
    def test_1930_VC_74354_set_get_sidetone_level(self) -> None:
        try:
    ...
    def test_1931_VC_74353_set_not_supported_value_of_sidetone_level(self) -> None:
        try:
    ...
    def test_1932_VC_82081_set_get_anc_mode_customization(self) -> None:
        try:
    ...
    def test_1933_VC_82082_set_wrong_anc_customization_mode(self) -> None:
        try:
    ...
    def test_1934_VC_74355_get_connected_device_num(self) -> None:
        try:
            response = (
    ...
    def test_1935_VC_74356_get_connected_device_info(self) -> None:
        try:
            response = (
    ...
    def test_1936_VC_74357_get_connected_device_name(self) -> None:
        try:
            ...
            response = (
                self.features.headset_bt_conn_info_feature.get_device_connected_name(
                    zone_950_api.dongle_bt_address
                )
            )
            self.features.headset_bt_conn_info_feature.verify_get_device_connected_name(
                response, zone_950_api.receiver_name
            )
        except Exception as ex:
            Report.logException(str(ex))

    def test_1937_VC_74359_get_audio_active_device(self) -> None:
        try:
            response = (
    ...
    def test_1938_VC_74361_connected_device_status(self) -> None:
        try:
            response = (
    ...
    def test_1939_VC_74362_connected_device_status_for_fake_device(self) -> None:
        try:
            response = (
                self.features.headset_bt_conn_info_feature.get_device_connected_status(
    ...
    def test_1940_VC_74364_get_set_A2DP_mute_status(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1941_VC_74363_set_not_supported_A2DP_state(self) -> None:
        try:
    ...
    def test_1942_VC_74365_get_pdl_device_numbers_and_info(self) -> None:
        try:
            number_response = (
    ...
    def test_1943_VC_74371_set_get_voice_notification_status(self) -> None:
        try:
            statuses = [0, 1, 2]
            for status in statuses:
    ...
    def test_1944_VC_74372_set_not_supported_voice_notification_value(self) -> None:
        try:
    ...
    def test_1945_VC_74373_factory_reset_device(self) -> None:
    ...
    def test_1946_VC_74368_set_get_mic_boom_status(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1947_VC_74369_set_not_supported_mic_boom_value(self) -> None:
        try:
    ...
    def test_1948_VC_79297_set_get_ai_reduction_state(self) -> None:
        try:
            statuses = [0, 1, 2, 3]
            for status in statuses:
    ...
    def test_1949_VC_79300_set_not_supported_ai_noise_reduction_state(self) -> None:
        try:
    ...
    def test_1950_VC_79299_set_get_anti_startle_state(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1951_VC_79302_set_not_supported_anti_startle_state(self) -> None:
        try:
    ...
    def test_1952_VC_79298_set_get_noise_exposure_state(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1953_VC_79301_set_not_supported_noise_exposure_state(self) -> None:
        try:
    ...
    def test_1954_VC_80432_set_get_ear_detection_state(self) -> None:
        try:
    ...
    def test_1955_VC_80434_set_not_supported_notification_state(self) -> None:
        try:
    ...
    def test_1956_VC_82083_set_get_auto_answer_on_call_state(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1957_VC_82084_set_not_supported_auto_answer_on_call_state(self) -> None:
        try:
    ...
    def test_1958_VC_82085_set_get_auto_mute_on_call_state(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1959_VC_82086_set_not_supported_auto_mute_on_call_state(self) -> None:
        try:
    ...
    def test_1960_VC_98853_set_get_touch_sensor_state(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1961_VC_98854_set_not_supported_touch_sensor_state(self) -> None:
        try:
    ...
    def test_1962_VC_98857_set_headset_active_eq(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
                for key, value in EQ_MODES.items():
    ...
    def test_1963_VC_98856_set_not_supported_headset_active_eq_state(self) -> None:
        try:
