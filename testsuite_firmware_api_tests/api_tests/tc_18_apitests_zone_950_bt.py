...
class ZoneWireless2ApiBtTests(UIBase):
    ...
    def test_1801_VC_74320_get_protocol_version(self) -> None:
        try:
    ...
    def test_1802_VC_74321_get_features(self):
        try:
    ...
    def test_1803_VC_74322_get_not_supported_feature(self) -> None:
        try:
    ...
    def test_1804_VC_74323_get_not_existing_feature(self) -> None:
        try:
    ...
    def test_1805_VC_74324_get_feature_count(self) -> None:
        try:
    ...
    def test_1806_VC_74325_get_feature_id(self) -> None:
        try:
    ...
    def test_1807_VC_74335_get_serial_number(self) -> None:
        try:
    ...
    def test_1808_VC_74336_get_firmware_version(self) -> None:
        try:
    ...
    def test_1809_VC_74337_get_hardware_info(self) -> None:
        try:
    ...
    def test_1810_VC_74338_set_and_get_device_name(self) -> None:
        try:
    ...
    def test_1811_VC_74339_get_default_device_name(self) -> None:
        try:
    ...
    def test_1812_VC_74340_get_max_length_name(self) -> None:
        try:
    ...
    def test_1813_VC_74341_set_longer_than_max_length_name(self) -> None:
        try:
    ...
    def test_1814_VC_74386_get_battery_status(self) -> None:
        try:
    ...
    def test_1815_VC_74387_get_voltage_info(self) -> None:
        try:
    ...
    def test_1816_VC_74345_set_get_sleep_timer(self) -> None:
        try:
    ...
    def test_1817_VC_74381_get_supported_language(self) -> None:
        try:
    ...
    def test_1818_VC_74382_set_not_supported_language(self) -> None:
        try:
    ...
    def test_1819_VC_74383_get_language_capability(self) -> None:
        try:
    ...
    def test_1820_VC_74342_set_get_eq(self) -> None:
        try:
    ...
    def test_1821_VC_74343_get_eq_modes(self) -> None:
        try:
    ...
    def test_1822_VC_74344_get_band_info(self) -> None:
        try:
    ...
    def test_1823_VC_74347_anc_off(self) -> None:
        try:
            tested_status = 0
            other_states = [1, 2, 3]
    ...
    def test_1824_VC_74348_anc_on(self) -> None:
        try:
            tested_status = 1
            other_states = [0, 2, 3]
            if self.features.headset_audio_feature.get_current_anc_state(
    ...
    def test_1825_VC_74349_transparency_on(self) -> None:
        try:
            tested_status = 2
            other_states = [0, 1, 3]
            if self.features.headset_audio_feature.get_current_anc_state(
    ...
    def test_1826_VC_74350_anc_low(self) -> None:
        try:
            tested_status = 3
            other_states = [0, 1, 2]
            if self.features.headset_audio_feature.get_current_anc_state(
    ...
    def test_1827_VC_74351_anc_with_not_supported_value(self) -> None:
        try:
    ...
    def test_1828_VC_74346_set_get_mic_mute_state(self) -> None:
        try:
            statuses = [0, 1]
    ...
    def test_1829_VC_74352_set_not_supported_mic_mute_value(self) -> None:
        try:
    ...
    def test_1830_VC_74354_set_get_sidetone_level(self) -> None:
        try:
    ...
    def test_1831_VC_74353_set_not_supported_value_of_sidetone_level(self) -> None:
        try:
    ...
    def test_1832_VC_82081_set_get_anc_mode_customization(self) -> None:
        try:
    ...
    def test_1833_VC_82082_set_wrong_anc_customization_mode(self) -> None:
        try:
    ...
    def test_1834_VC_74355_get_connected_device_num(self) -> None:
        try:
            response = (
    ...
    def test_1835_VC_74356_get_connected_device_info(self) -> None:
        try:
            response = (
    ...
    def test_1836_VC_74357_get_connected_device_name(self) -> None:
        try:
    ...
    def test_1837_VC_74359_get_audio_active_device(self) -> None:
        try:
            response = (
    ...
    def test_1838_VC_74361_connected_device_status(self) -> None:
        try:
            response = (
    ...
    def test_1839_VC_74362_connected_device_status_for_fake_device(self) -> None:
        try:
            response = (
                self.features.headset_bt_conn_info_feature.get_device_connected_status(
    ...
    def test_1840_VC_74364_get_set_A2DP_mute_status(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1841_VC_74363_set_not_supported_A2DP_state(self) -> None:
        try:
    ...
    def test_1842_VC_74365_get_pdl_device_numbers_and_info(self) -> None:
        try:
            number_response = (
    ...
    def test_1843_VC_74371_set_get_voice_notification_status(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1844_VC_74372_set_not_supported_voice_notification_value(self) -> None:
        try:
    ...
    def test_1845_VC_74373_factory_reset_device(self) -> None:
    ...
    def test_1846_VC_74368_set_get_mic_boom_status(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1847_VC_74369_set_not_supported_mic_boom_value(self) -> None:
        try:
    ...
    def test_1848_VC_79297_set_get_ai_reduction_state(self) -> None:
        try:
            statuses = [0, 1, 2, 3]
            for status in statuses:
    ...
    def test_1849_VC_79300_set_not_supported_ai_noise_reduction_state(self) -> None:
        try:
    ...
    def test_1850_VC_79299_set_get_anti_startle_state(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1851_VC_79302_set_not_supported_anti_startle_state(self) -> None:
        try:
    ...
    def test_1852_VC_79298_set_get_noise_exposure_state(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1853_VC_79301_set_not_supported_noise_exposure_state(self) -> None:
        try:
    ...
    def test_1854_VC_80432_set_get_ear_detection_state(self) -> None:
        try:
    ...
    def test_1855_VC_80434_set_not_supported_notification_state(self) -> None:
        try:
    ...
    def test_1856_VC_82083_set_get_auto_answer_on_call_state(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1857_VC_82084_set_not_supported_auto_answer_on_call_state(self) -> None:
        try:
    ...
    def test_1858_VC_82085_set_get_auto_mute_on_call_state(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1859_VC_82086_set_not_supported_auto_mute_on_call_state(self) -> None:
        try:
    ...
    def test_1860_VC_98853_set_get_touch_sensor_state(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_1861_VC_98854_set_not_supported_touch_sensor_state(self) -> None:
        try:
    ...
    def test_1862_VC_98857_set_headset_active_eq(self) -> None:
        try:
            statuses = [0, 1]
            for status in statuses:
                for key, value in EQ_MODES.items():
    ...
    def test_1863_VC_98856_set_not_supported_headset_active_eq_state(self) -> None:
        try:
