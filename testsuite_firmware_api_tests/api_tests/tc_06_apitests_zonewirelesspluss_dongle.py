...
class ZoneWirelessPlusAPITestsDongle(UIBase):
    """
    ...
    @classmethod
    def setUpClass(cls):
        super(ZoneWirelessPlusAPITestsDongle, cls).setUpClass()
    ...
    def test_601_VC_57498_get_protocol_version(self):
        try:
    ...
    def test_602_VC_57499_get_features(self):
        try:
    ...
    def test_603_VC_57500_get_not_supported_feature(self):
        try:
    ...
    def test_604_VC_57501_get_not_existing_feature(self):
        try:
    ...
    def test_605_VC_57502_get_feature_count(self):
        try:
    ...
    def test_606_VC_57503_get_feature_id(self):
        try:
    ...
    def test_607_VC_57513_get_serial_number(self):
        try:
    ...
    def test_608_VC_57514_get_firmware_version(self):
        try:
    ...
    def test_609_VC_57515_get_hardware_info(self):
        try:
            hw_revision = '02'
    ...
    def test_610_VC_57516_set_and_get_device_name(self):
        try:
    ...
    def test_611_VC_57517_get_default_device_name(self):
        try:
    ...
    def test_612_VC_57518_get_max_length_name(self):
        try:
    ...
    def test_613_VC_57519_set_longer_than_max_length_name(self):
        try:
    ...
    def test_614_VC_57520_set_get_eq(self):
    ...
    def test_615_VC_57523_set_get_sleep_timer(self):
        try:
    ...
    def test_616_VC_57571_get_bt_state(self):
        try:
    ...
    def test_617_VC_57570_set_discoverable_state(self):
    ...
    def test_618_VC_57524_set_get_mic_mute_state(self):
        try:
            statuses = [0, 1]
    ...
    def test_619_VC_57529_set_not_supported_mic_mute_value(self):
        try:
    ...
    def test_620_VC_57525_disable_anc(self):
        try:
            tested_status = 0
            other_states = [1, 2]
    ...
    def test_621_VC_57526_enable_anc(self):
        try:
            tested_status = 1
            other_states = [0, 2]
            if self.features.headset_audio_feature.get_current_anc_state() == f"{tested_status:02x}":
    ...
    def test_622_VC_57528_anc_with_not_supported_value(self):
        try:
    ...
    def test_623_VC_57531_set_get_sidetone_level(self):
        try:
    ...
    def test_624_VC_57530_set_not_supported_value_of_sidetone_level(self):
        try:
    ...
    def test_625_VC_57532_get_connected_device_num(self):
        try:
    ...
    def test_626_VC_57533_get_connected_device_info(self):
        try:
    ...
    def test_627_VC_57534_get_connected_device_name(self):
        try:
            response = self.features.headset_bt_conn_info_feature.get_device_connected_name(zone_wireless_plus_api.dongle_bt_address)
            self.features.headset_bt_conn_info_feature.verify_get_device_connected_name(response, zone_wireless_plus_api.receiver_name)
        except Exception as e:
            Report.logException(str(e))

    def test_628_VC_57536_get_audio_active_device(self):
        try:
            response = self.features.headset_bt_conn_info_feature.get_audio_active_device()
            self.features.headset_bt_conn_info_feature.verify_get_audio_active_device(response, zone_wireless_plus_api.dongle_bt_address, '00')
        except Exception as e:
            Report.logException(str(e))

    def test_629_VC_57537_get_dongle_fw_version(self):
        try:
            response = self.features.headset_bt_conn_info_feature.get_dongle_fw_version()
            self.features.headset_bt_conn_info_feature.verify_get_dongle_fw_version(response, zone_wireless_plus_api.dongle_firmware_version)
        except Exception as e:
            Report.logException(str(e))

    def test_630_VC_57538_connected_device_status(self):
        try:
            response = self.features.headset_bt_conn_info_feature.get_device_connected_status(zone_wireless_plus_api.dongle_bt_address)
            self.features.headset_bt_conn_info_feature.verify_get_device_connected_status(response, CONNECTED)
        except Exception as e:
            Report.logException(str(e))

    def test_631_VC_57539_connected_device_status_for_fake_device(self):
        try:
    ...
    def test_632_VC_57541_get_set_A2DP_mute_status(self):
        try:
            statuses = [0, 1]
            for status in statuses:
                self.features.headset_bt_conn_info_feature.set_A2DP_mute_status(zone_wireless_plus_api.dongle_bt_address, status)
                response = self.features.headset_bt_conn_info_feature.get_A2DP_mute_status(zone_wireless_plus_api.dongle_bt_address)
    ...
    def test_633_VC_57540_set_not_supported_A2DP_state(self):
        try:
            response = self.features.headset_bt_conn_info_feature.set_A2DP_mute_status(zone_wireless_plus_api.dongle_bt_address,
                                                                                       random.randint(2, 255))
            self.features.headset_bt_conn_info_feature.verify_not_supported_A2DP_mu_status(response)
        except Exception as e:
            Report.logException(str(e))

    def test_634_VC_57542_get_pdl_device_numbers_and_info(self):
        try:
    ...
    def test_635_VC_57548_set_get_voice_notification_status(self):
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_636_VC_57549_set_not_supported_voice_notification_value(self):
        try:
    ...
    def test_637_VC_57550_factory_reset_device(self):
        Report.logSkip("manual")
        self.skipTest("manual")
        try:
    ...
    def test_638_VC_57545_set_get_mic_boom_status(self):
        try:
            statuses = [0, 1]
            for status in statuses:
    ...
    def test_639_VC_57546_set_not_supported_mic_boom_value(self):
        try:
    ...
    def test_640_VC_57551_set_get_button_general_settings(self):
        try:
    ...
    def test_641_VC_57552_get_button_individual_capability(self):
        try:
            buttons = [0, 1]
    ...
    def test_642_VC_57557_reset_button_customization_settings(self):
        try:
            for button_index, values in BUTTONS_CAPABILITIES_BY_FUNCTIONS.items():
                long_press = random.choice(values[0])
                short_press = random.choice(values[1])
    ...
    def test_643_VC_57553_get_capability_for_not_existing_button(self):
        try:
    ...
    def test_644_VC_57554_set_not_supported_capablity_for_long_press_buttons(self):
        try:
            for button_index, values in BUTTONS_CAPABILITIES_BY_FUNCTIONS.items():
    ...
    def test_645_VC_57555_set_not_supported_capablity_for_short_press_buttons(self):
        try:
            for button_index, values in BUTTONS_CAPABILITIES_BY_FUNCTIONS.items():
                long_press = random.choice(values[0])
    ...
    def test_646_VC_57556_set_not_supported_capability_for_double_press_buttons(self):
        try:
            for button_index, values in BUTTONS_CAPABILITIES_BY_FUNCTIONS.items():
                long_press = random.choice(values[0])
                short_press = random.choice(values[1])
    ...
    def test_647_VC_57558_get_supported_language(self):
        try:
    ...
    def test_648_VC_57559_set_not_supported_language(self):
        Report.logSkip("manual")
        self.skipTest("manual")
        try:
    ...
    def test_649_VC_57560_get_language_capability(self):
        Report.logSkip("manual")
        self.skipTest("manual")
        try:
    ...
    def test_650_VC_57561_set_get_earcon_state(self):
        try:
            states = [0, 1]
            for state in states:
    ...
    def test_651_VC_57562_set_not_supported_earcon_state(self):
        try:
    ...
    def test_652_VC_57563_get_battery_status(self):
        try:
    ...
    def test_653_VC_57564_get_voltage_info(self):
        try:
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(ZoneWirelessPlusAPITestsDongle)
