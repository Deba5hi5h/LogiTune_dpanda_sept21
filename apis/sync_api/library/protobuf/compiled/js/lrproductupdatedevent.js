...
goog.provide('proto.logi.proto.LRProductUpdatedEvent');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.logi.proto.LRProductSnapshot');
...
proto.logi.proto.LRProductUpdatedEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    orgInfoTimestamp: +jspb.Message.getFieldWithDefault(msg, 1, 0.0),
    orgPolicyTimestamp: +jspb.Message.getFieldWithDefault(msg, 2, 0.0),
    roomInfoTimestamp: +jspb.Message.getFieldWithDefault(msg, 3, 0.0),
    roomPolicyTimestamp: +jspb.Message.getFieldWithDefault(msg, 4, 0.0),
    snapshotsList: jspb.Message.toObjectList(msg.getSnapshotsList(),
    proto.logi.proto.LRProductSnapshot.toObject, includeInstance)
  };
...
proto.logi.proto.LRProductUpdatedEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.logi.proto.LRProductSnapshot;
      reader.readMessage(value,proto.logi.proto.LRProductSnapshot.deserializeBinaryFromReader);
...
proto.logi.proto.LRProductUpdatedEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      5,
      f,
      proto.logi.proto.LRProductSnapshot.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional double org_info_timestamp = 1;
 * @return {number}
 */
...
/**
 * optional double org_policy_timestamp = 2;
 * @return {number}
 */
...
/**
 * optional double room_info_timestamp = 3;
 * @return {number}
 */
...
/**
 * optional double room_policy_timestamp = 4;
 * @return {number}
 */
...
proto.logi.proto.LRProductUpdatedEvent.prototype.getSnapshotsList = function() {
  return /** @type{!Array<!proto.logi.proto.LRProductSnapshot>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.logi.proto.LRProductSnapshot, 5));
};
