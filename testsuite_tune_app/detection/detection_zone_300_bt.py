...
from common.framework_params import ZONE_300_RELAY_BOARD_SERIAL_NUMBER, ZONE_300_POWER_ON_OFF_PAIR_BUTTON
...
class DetectZone300Bt(UIBase):
    # used in tearDown to update test status on zephyr
    tune_app = TuneElectron()
    device_name = zone_300_api.name
    ...
    def setUp(self):
        ...
        """
        try:
            super(DetectZone300Bt, self).setUp()
            log.info('Starting {}'.format(self._testMethodName))

            disconnect_all()

            # Communicate with the relay connected with Zone 300
            relay_com_port = self.ryCtrl.get_relay_com_port(ZONE_300_RELAY_BOARD_SERIAL_NUMBER)
    ...
    def tearDownClass(cls):
        ...
        cls.ryCtrl.press_btn(ZONE_300_POWER_ON_OFF_PAIR_BUTTON, 0.3)
        time.sleep(5)
        cls.ryCtrl.press_btn(ZONE_300_POWER_ON_OFF_PAIR_BUTTON, 0.3)
        ...
        cls.btCtrl.bluetooth_unpair(zone_300_api.headset_bt_address, cls.device_name)

        super(DetectZone300Bt, cls).tearDownClass()

    def test_XXX_VC_125092_detect_zone_300_bt(self):
        ...
        try:
            ...
            for i in range(1, 6):
                ...
                self.ryCtrl.press_btn(ZONE_300_POWER_ON_OFF_PAIR_BUTTON, 3)
    ...
    def test_XXX_VC_125093_power_on_off_zone_300_bt(self):
        """Verification of detection of Zone 300 via bluetooth after power on/off"""
        ...
        try:
            ...
            for i in range(1, 6):
                ...
                # For Zone 300 press button over 0.5 sec will enter pairing mode
                self.ryCtrl.press_btn(ZONE_300_POWER_ON_OFF_PAIR_BUTTON, 0.3)
                time.sleep(5)
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(DetectZone300Bt)
