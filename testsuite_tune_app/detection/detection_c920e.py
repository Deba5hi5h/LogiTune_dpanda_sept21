...
class DetectC920E(UIBase):

    def test_XXX_VC_YYYYY_detect_c920e(self):
        device_name = "C920E"
        ...
        try:
            ...
            for i in range(1, 3):
                ...
                time.sleep(10)
                self.tunesApp.is_device_label_displayed("C920e")
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(DetectC920E)
