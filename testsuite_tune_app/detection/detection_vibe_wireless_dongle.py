...
class DetectZoneVibeWirelessDongle(UIBase):
    ...
    def test_XXX_VC_103776_detect_zone_vibe_wireless_dongle(self):
        """Verification of detecting Zone Vibe Wireless through dongle connection
        This test powers off dongle which is plugged on USB hub and then powers on to check Zone Vibe Wireless connection
        It will fail if the battery sign is not showed up in Zone Vibe Wireless page on Tune
        """
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(DetectZoneVibeWirelessDongle)
