...
from common.framework_params import ZV130_RELAY_BOARD_SERIAL_NUMBER, ZV130_POWER_ON_BUTTON, ZV130_POWER_OFF_BUTTON, ZV130_POWER_PAIR_BUTTON
...
class DetectZoneVibe130Bt(UIBase):
    ...
    def setUp(self):
        ...
        """
        try:
            super(DetectZoneVibe130Bt, self).setUp()
            ...
            relay_com_port = self.ryCtrl.get_relay_com_port(ZV130_RELAY_BOARD_SERIAL_NUMBER)
            self.ryCtrl.connect_relay(relay_com_port)

        except Exception as e:
            log.error('Unable to setUp test_XXX_VC_YYYYY_detect_vibe130_bt')
            raise e
    ...
    def tearDown(self):
        ...
        self.ryCtrl.press_btn(ZV130_POWER_OFF_BUTTON, 3)
        self.ryCtrl.press_btn(ZV130_POWER_ON_BUTTON, 1)
        ...
        self.btCtrl.bluetooth_unpair(zone_vibe_130_api.headset_bt_address, zone_vibe_130_api.name)

        super(DetectZoneVibe130Bt, self).tearDown()

    def test_XXX_VC_123390_detect_zone_vibe_130_bt(self):
        """Verification of detection of Zone Vibe 130 via bluetooth
        This test pairs and PC with Zone Vibe 130 via bluetooth and check the info on Tune
        It will fail if Tune does not show Zone Vibe 130 on the page
        """
        device_name = zone_vibe_130_api.name
        ...
        try:
            ...
            for i in range(1, 3):
                ...
                self.ryCtrl.press_btn(ZV130_POWER_ON_BUTTON, 1)
                self.ryCtrl.press_btn(ZV130_POWER_PAIR_BUTTON, 3)
    ...
    def test_XXX_VC_103782_power_on_off_zone_vibe_130_bt(self):
        """Verification of detection of Zone Vibe 130 via bluetooth after power on/off"""
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(DetectZoneVibe130Bt)
