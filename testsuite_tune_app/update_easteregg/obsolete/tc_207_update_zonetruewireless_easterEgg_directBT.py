...
class UpdateZoneTrueWirelessBTConnection(FwuStressBase):
    ...
    def test_207_VC_58902_upgrade_downgrade_zonetruewireless_firmware_directBT_connection(self, loop_no, ver):
        """
        Scenario:
        1. Downgrade Earbuds via Easter Egg.
        2. Update Earbuds via Easter Egg.
        """
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(UpdateZoneTrueWirelessBTConnection)
