...
class UpdateZone950(FwuStressBase):
    """
    Suite class for Zone 950 connected over BT FWU tests via EasterEgg and OTA.
    """
    ...
    @parameterized.expand([(x,) for x in range(1, zone_950.repeats + 1)])
    def test_214_VC_74092_update_zone_950_directBT(self, retry):
        """
        Scenario:
...
if __name__ == "__main__":
    suite = unittest.TestLoader().loadTestsFromTestCase(UpdateZone950)
