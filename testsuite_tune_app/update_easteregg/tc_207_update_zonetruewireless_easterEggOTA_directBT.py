...
class UpdateZoneTrueWirelessBTConnection(FwuStressBase):
    """
    Suite class for Zone True Wireless connected over direct BT FWU tests via EasterEgg and OTA.
    """
    ...
    def test_207_VC_58902_upgrade_downgrade_zonetruewireless_firmware_directBT_connection(
        self, retry
    ):
        """
        Scenario:
...
if __name__ == "__main__":
    suite = unittest.TestLoader().loadTestsFromTestCase(
        UpdateZoneTrueWirelessBTConnection
    )
