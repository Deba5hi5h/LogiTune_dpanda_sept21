...
class UpdateZoneTrueWirelessDongleBTCConnection(FwuStressBase):
    """
    Suite class for Zone True Wireless connected over BT dongle FWU tests via EasterEgg and OTA.
    """
    ...
    def setUpClass(cls) -> None:
        super(UpdateZoneTrueWirelessDongleBTCConnection, cls).setUpClass()
        cls.device_name = zone_true_wireless.device_name
        ...
        cls.file_path_dongle = os.path.join(
            DIR_PATH, f"ZAXXON_BTC_{cls.baseline_version_dongle}.dfu"
        )
    ...
    def test_208_VC_58903_upgrade_downgrade_zonetruewireless_firmware_dongleBTC_connection(
        self, retry
    ):
        """
        Scenario:
...
if __name__ == "__main__":
    suite = unittest.TestLoader().loadTestsFromTestCase(
        UpdateZoneTrueWirelessDongleBTCConnection
    )
