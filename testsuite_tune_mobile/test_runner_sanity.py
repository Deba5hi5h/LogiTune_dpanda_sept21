...
# Run Configuration
tune_mobile_config.phone = "Pixel2"
tune_mobile_config.teammate_phone = "Pixel6"
tune_mobile_config.building = "Logi-Auto"
prod_version = '3.14.0-30062'
qa_version = '3.15.0-30066'
...
real_device = True if tune_mobile_config.phone in ("iPhone12", "Pixel2") else False
...
global_variables.test_category = "Sanity" if real_device else "Scheduler-Sanity"
